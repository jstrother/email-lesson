...
/***/ function(module, exports, __webpack_require__) {
	...
	var Inbox = function Inbox(props) {
		var emails = Object.keys(props.emails.inbox).map(function (emailID, index) {
			...
			return React.createElement(
				'li',
				{ key: index },
				React.createElement(Email, { id: email.id, from: email.from, to: email.to, title: email.title, content: email.content })
			);
		});
	...
	var InboxContainer = function InboxContainer() {
		return React.createElement(
			'div',
			null,
			React.createElement(Inbox, { emails: EMAILS })
		);
	};
	
	var SpamContainer = function SpamContainer() {
		return React.createElement(
			'div',
			null,
			React.createElement(Spam, { emails: EMAILS })
		);
	};
	...
	var routes = React.createElement(
		...
		React.createElement(Route, { path: '/inbox', component: InboxContainer }),
		React.createElement(Route, { path: '/spam', component: SpamContainer })
	);
